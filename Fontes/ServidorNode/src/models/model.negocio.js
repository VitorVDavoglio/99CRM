...
function Inserir(json_neg, callback){
    ...
    db.query(ssql, [json_neg.id_usuario, json_neg.etapa, json_neg.descricao, json_neg.empresa,
        json_neg.contato, json_neg.fone, json_neg.email, json_neg.valor
    ], function(err, result){
        if (err){
            callback(err, []);
        } else {
...
function Editar(id_negocio, json_neg, callback){
    ...
    db.query(ssql, [json_neg.etapa, json_neg.descricao, json_neg.empresa,
        json_neg.contato, json_neg.fone, json_neg.email, json_neg.valor, id_negocio
    ], function(err, result){
        if (err){
            callback(err, []);
        } else {
